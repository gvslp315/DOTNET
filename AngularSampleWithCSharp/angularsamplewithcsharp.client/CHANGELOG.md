...
- Create Angular project with ng: `ng new angularsamplewithcsharp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularsamplewithcsharp.client.esproj`).
